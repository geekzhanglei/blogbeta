                                    ...
                                    '<ul>',
                                        '<li v-for="item in comments">',
                                            '<div class="cont clearfix">',
                                                '<div class="title">',
                                                    '<span v-if="item.website"><a :href="item.website">{{item.nickname}}</a> 说</span>',
                                                ...
                                                '</div>',
                                                '<div class="foot">',
                                                    '<p><span>{{transferTime(item.create_time)}}</span> | <span>引用</span></p>',
                                                '</div>',
                                            '</div>',
                                        '</li>',
                                    '</ul>',
                                    ...
                                    '<form>',
                                        '<div id="comments-open-data">',
                                            ...
                                            '<div id="comment-form-url">',
                                                ...
                                                '<p>',
                                                    '<input size="30" v-model="comment.website">',
                                            ...
                                            '<div id="comment-form-remember-me">',
                                                '<p>',
                                                    ...
                                                    '<input type="checkbox" onclick="saveCookie(this.checked)">',
                                                '</p>',
                                            '</div>',
                                        '</div>',

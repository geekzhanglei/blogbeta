        ...
        '<nav aria-label="Page navigation">',
            '<ul class="pagination">',
                ...
                '<li v-if="datasource.page >= 4 && datasource.page_total > 5">',
                    '<a v-on:click="onClickPage(datasource.clickPageCb, 1)" href="javascript:;"><</a>',
                '</li>',
                ...
                '<li v-if="datasource.page <= datasource.page_total -3 && datasource.page_total > 5">',
                    '<a v-on:click="onClickPage(datasource.clickPageCb, datasource.page_total)" href="javascript:;">></a>',
                '</li>',

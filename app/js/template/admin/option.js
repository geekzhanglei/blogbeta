        ...
        '<div class="ad-admin-manage-wrap admin-options-wrap">',
            ...
            '<form class="form-inline clearfix">',
                '<div class="form-group col-sm-6">',
                    ...
                    '<input type="text" id="msgName" class="form-control" @input="modifyName($event,1)" placeholder="输入留言默认昵称">',
                '</div>',
                '<div class="form-group col-sm-6">',
                    '<label for="replyName" class="control-label">回复默认昵称</label>',
                    '<input type="text" id="replyName" class="form-control" @input="modifyName($event,2)" placeholder="输入回复默认昵称">',
                '</div>',
            '</form>',
        '</div>'
    ].join('');

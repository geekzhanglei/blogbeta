        ...
        '<div>',
            ...
            '<aside class="admin-sidebar" v-bind:class="{sidebarWidth:isCollapse}">',
                     '<ul class="ad-sidebar-normal" v-if="isCollapse">',
                        '<router-link tag="li" to="release" replace><a class="ad-sidebar-li-a"><i class="glyphicon glyphicon-list-alt"></i><span>发表文章</span></a>',
                        '</router-link>',
                    ...
                    '<ul class="ad-sidebar-collapse" v-else>',
                        '<router-link tag="li" to="release" replace><a class="ad-sidebar-li-a"><i class="glyphicon glyphicon-list-alt"></i></a>',
                        '</router-link>',

            ...
            '<div class="row msg-wrap">',
                ...
                '<div class="msg-cont">',
                    '<div class="msg-input clearfix">',
                        ...
                        '<button type="button" class="btn btn-default" v-on:click="showLayer()"  data-toggle="modal" data-target="#inputNameModal">评论一下</button>',
                    '</div>',
                ...
                '<div class="modal-dialog  modal-sm" role="document">',
                    '<div class="modal-content">',
                        '<div class="modal-header">',
                            ...
                            '<h4 class="modal-title" id="myModalLabel">取个名字呗：</h4>',
                        '</div>',
                        '<div class="modal-body">',
                            '<input type="text" class="form-control" placeholder="东方三侠">',
                        '</div>',
                        '<div class="modal-footer">',
                            '<button type="button" class="btn btn-primary">确认发表</button>',
                        '</div>',
                    '</div>',
                '</div>',
            '</div>',

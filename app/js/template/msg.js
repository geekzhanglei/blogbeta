            ...
            '<div class="row msg-wrap">',
                ...
                '<div class="msg-cont">',
                    '<div class="msg-input clearfix">',
                        ...
                        '<button type="button" class="btn btn-default" data-toggle="modal" data-target="#inputNameModal">评论一下</button>',
                    '</div>',
                ...
                '<div class="modal-dialog  modal-sm" role="document">',
                    '<div class="modal-content">',
                        ...
                        '<div class="modal-body">',
                            '<input type="text" v-model="inputName" class="form-control" maxlength="10" placeholder="东方三侠">',
                        '</div>',
                        '<div class="modal-footer">',
                            '<button type="button" class="btn btn-primary" v-on:click="sendComment()">确认发表</button>',
                        '</div>',
                    '</div>',
                '</div>',
            '</div>',

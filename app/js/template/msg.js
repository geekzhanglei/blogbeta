                        ...
                        '<div class="cont-list">',
                            '<div class="comments" v-for="(item,index) in list">',
                                ...
                                '<div class="write-answer" v-show="item.isShowInput">',
                                    ...
                                    '</div>',
                                '</div>',
                                '<div class="answers" v-show="item.isShowAnswers" v-for="(answer,i) in item.reply">',
                                    '<div class="clearfix">',
                                    ...
                                    '<div class="action clearfix">',
                                        ...
                                        '<a v-if="answer.supNum != 0">{{answer.supNum}}</a>',
                                    '</div>',
                                    '<div class="write-answer" v-show="answer.isShowReplyInput">',
                                        '<div class="msg-input clearfix">',
                                            '<textarea class="form-control" rows="2 " maxlength="100" v-model="item.replyCont"></textarea>',
                                            '<div class="replyWrap clearfix">',
                                                '<span>昵称：</span>',
                                                '<input type="text" v-model="item.replyName" class="form-control"  maxlength="10" v-bind:placeholder="phcont">',
                                                '<button type="button" class="btn btn-default" v-on:click="addReply(item.id,item,i)">回复一下</button>',
                                                '<span class="replyErrTip">{{item.replyErr}}</span>',
                                            '</div>',
                                        '</div>',
                                    '</div>',
